	...
	while (!pq.empty()) {
		...
		for (i = adj[u].begin(); i != adj[u].end(); ++i) 
		{
			...
			if (dist[v] > dist[u] + weight) {
				...
				printf("update distance form %d to %d : %d\n", v, u, dist[v]);
				//TODO: Create a parent array, update the parent array when distance is updated and use it to show the shortest path from source to different vertices.
			}
		}
	}
